...
const allowedOrigins = ['https://employee-management-server-seven.vercel.app'];
app.use(cors({
  ...
  credentials: true, // This is important for allowing credentials (cookies, HTTP authentication) in the request
}));
